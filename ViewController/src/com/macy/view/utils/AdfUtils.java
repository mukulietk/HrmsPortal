...
public class AdfUtils
{
  ...
  {
    return (ApplicationModule) JsfUtils.getEL("#{data." + name + ".dataProvider}");
  }
  ...
  {
    return (BindingContainer) JsfUtils.getEL("#{bindings}");
  }
  ...
  /** Custom method to be used to execute Bidnings
   * @param bindingName bidning or methodBinding Name
   * @return the object, if it is to be returned by binding.
   */
  public static Object executeOperationBinding(String bindingName)
  {
  ...
  /**
   * Generic method to invoke the EL
   * @param elExpression - EL to be invoked
   * @return - return values
   */
  public static Object invokeEL(String elExpression)
  {
    FacesContext facesContext = FacesContext.getCurrentInstance();
    ExpressionFactory exprFactory = facesContext.getApplication().getExpressionFactory();
    MethodExpression methodExpr =
      exprFactory.createMethodExpression(facesContext.getELContext(), elExpression, Object.class, new Class[]
    { });
    return methodExpr.invoke(facesContext.getELContext(), null);
  }

  /**
   * Generic method to invoke the EL with parameters
   * @param el - EL to be invoked
   * @param paramTypes - Array of Types
